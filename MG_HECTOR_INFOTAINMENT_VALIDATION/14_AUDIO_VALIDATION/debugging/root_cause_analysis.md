# Root Cause Analysis Template: Audio Validation

## Problem Statement

During audio validation validation, the IVI behavior deviated from requirement under a defined bench state.
