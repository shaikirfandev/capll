# Automation Plan: Audio Validation
...
- `test_audio_validation_smoke`
- `test_audio_validation_negative_missing_signal`
- `test_audio_validation_sleep_wakeup_recovery`
- `test_audio_validation_stress_cycles`
