# OEM Validation Lab Manual: Audio Validation

## Lab Objective

Validate audio validation on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for audio validation.
