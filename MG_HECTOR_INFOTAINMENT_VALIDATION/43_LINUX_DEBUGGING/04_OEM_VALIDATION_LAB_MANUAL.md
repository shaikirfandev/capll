# OEM Validation Lab Manual: Linux Debugging

## Lab Objective

Validate linux debugging on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for linux debugging.
