# Root Cause Analysis Template: Boot Time Analysis

## Problem Statement

During boot time analysis validation, the IVI behavior deviated from requirement under a defined bench state.
