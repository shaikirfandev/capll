# Automation Plan: Boot Time Analysis
...
- `test_boot_time_analysis_smoke`
- `test_boot_time_analysis_negative_missing_signal`
- `test_boot_time_analysis_sleep_wakeup_recovery`
- `test_boot_time_analysis_stress_cycles`
