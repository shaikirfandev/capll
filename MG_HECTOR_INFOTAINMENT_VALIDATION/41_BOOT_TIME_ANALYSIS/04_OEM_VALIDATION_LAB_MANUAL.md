# OEM Validation Lab Manual: Boot Time Analysis

## Lab Objective

Validate boot time analysis on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for boot time analysis.
