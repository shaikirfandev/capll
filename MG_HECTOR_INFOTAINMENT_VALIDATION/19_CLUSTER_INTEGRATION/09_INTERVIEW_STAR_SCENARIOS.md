# Interview STAR Scenarios: Cluster Integration

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Cluster Integration failed during bench execution.
...
Task: Automate repeatable checks for cluster integration.
