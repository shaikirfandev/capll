# OEM Validation Lab Manual: Cluster Integration

## Lab Objective

Validate cluster integration on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for cluster integration.
