# Automation Plan: Cluster Integration
...
- `test_cluster_integration_smoke`
- `test_cluster_integration_negative_missing_signal`
- `test_cluster_integration_sleep_wakeup_recovery`
- `test_cluster_integration_stress_cycles`
