# Root Cause Analysis Template: Cluster Integration

## Problem Statement

During cluster integration validation, the IVI behavior deviated from requirement under a defined bench state.
