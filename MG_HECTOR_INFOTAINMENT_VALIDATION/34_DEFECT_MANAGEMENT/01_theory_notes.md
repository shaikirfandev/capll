# Theory Notes: Defect Management

## Engineering View

In production infotainment validation, defect management is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: Jira-quality defects, severity, triage and retest workflow.
