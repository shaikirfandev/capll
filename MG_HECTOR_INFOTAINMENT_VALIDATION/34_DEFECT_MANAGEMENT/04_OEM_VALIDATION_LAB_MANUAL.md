# OEM Validation Lab Manual: Defect Management

## Lab Objective

Validate defect management on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for defect management.
