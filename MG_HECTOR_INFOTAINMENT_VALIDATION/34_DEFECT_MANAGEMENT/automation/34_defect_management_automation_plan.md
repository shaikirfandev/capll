# Automation Plan: Defect Management
...
- `test_defect_management_smoke`
- `test_defect_management_negative_missing_signal`
- `test_defect_management_sleep_wakeup_recovery`
- `test_defect_management_stress_cycles`
