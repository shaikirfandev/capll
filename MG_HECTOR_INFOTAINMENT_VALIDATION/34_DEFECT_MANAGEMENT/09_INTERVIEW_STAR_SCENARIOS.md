# Interview STAR Scenarios: Defect Management

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Defect Management failed during bench execution.
...
Task: Automate repeatable checks for defect management.
