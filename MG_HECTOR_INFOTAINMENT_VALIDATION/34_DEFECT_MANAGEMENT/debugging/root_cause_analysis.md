# Root Cause Analysis Template: Defect Management

## Problem Statement

During defect management validation, the IVI behavior deviated from requirement under a defined bench state.
