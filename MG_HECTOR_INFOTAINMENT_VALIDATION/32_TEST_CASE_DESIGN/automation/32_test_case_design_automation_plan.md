# Automation Plan: Test Case Design
...
- `test_test_case_design_smoke`
- `test_test_case_design_negative_missing_signal`
- `test_test_case_design_sleep_wakeup_recovery`
- `test_test_case_design_stress_cycles`
