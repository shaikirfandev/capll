# OEM Validation Lab Manual: IVI Features

## Lab Objective

Validate ivi features on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for ivi features.
