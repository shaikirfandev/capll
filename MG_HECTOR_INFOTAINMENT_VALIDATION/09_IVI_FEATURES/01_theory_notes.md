# Theory Notes: IVI Features

## Engineering View

In production infotainment validation, ivi features is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: radio, media, phone, navigation, UI, profiles and notifications.
