...
- `test_ivi_features_smoke`
- `test_ivi_features_negative_missing_signal`
- `test_ivi_features_sleep_wakeup_recovery`
- `test_ivi_features_stress_cycles`
