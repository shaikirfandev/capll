# OEM Validation Lab Manual: Memory Leak Analysis

## Lab Objective

Validate memory leak analysis on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for memory leak analysis.
