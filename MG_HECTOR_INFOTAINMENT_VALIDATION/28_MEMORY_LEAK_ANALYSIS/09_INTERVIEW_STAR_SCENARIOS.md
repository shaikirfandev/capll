# Interview STAR Scenarios: Memory Leak Analysis

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Memory Leak Analysis failed during bench execution.
...
Task: Automate repeatable checks for memory leak analysis.
