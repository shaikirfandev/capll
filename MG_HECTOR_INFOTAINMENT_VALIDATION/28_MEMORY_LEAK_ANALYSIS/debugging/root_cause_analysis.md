# Root Cause Analysis Template: Memory Leak Analysis

## Problem Statement

During memory leak analysis validation, the IVI behavior deviated from requirement under a defined bench state.
