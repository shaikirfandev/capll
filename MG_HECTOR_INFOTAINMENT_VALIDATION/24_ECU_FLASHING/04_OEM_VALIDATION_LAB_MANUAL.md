# OEM Validation Lab Manual: ECU Flashing

## Lab Objective

Validate ecu flashing on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for ecu flashing.
