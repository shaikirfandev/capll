# Theory Notes: ECU Flashing

## Engineering View

In production infotainment validation, ecu flashing is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: programming session, erase, transfer data and recovery.
