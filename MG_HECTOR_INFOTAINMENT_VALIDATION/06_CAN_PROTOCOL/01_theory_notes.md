# Theory Notes: CAN Protocol

## Engineering View

In production infotainment validation, can protocol is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: CAN frames, DBC signals, timing, bus load and trace analysis.
