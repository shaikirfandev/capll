# OEM Validation Lab Manual: CAN Protocol

## Lab Objective

Validate can protocol on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for can protocol.
