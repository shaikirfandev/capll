...
- `test_can_protocol_smoke`
- `test_can_protocol_negative_missing_signal`
- `test_can_protocol_sleep_wakeup_recovery`
- `test_can_protocol_stress_cycles`
