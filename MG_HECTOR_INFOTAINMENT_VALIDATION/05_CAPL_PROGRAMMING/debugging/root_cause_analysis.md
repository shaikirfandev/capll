# Root Cause Analysis Template: CAPL Programming

## Problem Statement

During capl programming validation, the IVI behavior deviated from requirement under a defined bench state.
