# Automation Plan: CAPL Programming
...
- `test_capl_programming_smoke`
- `test_capl_programming_negative_missing_signal`
- `test_capl_programming_sleep_wakeup_recovery`
- `test_capl_programming_stress_cycles`
