# OEM Validation Lab Manual: CAPL Programming

## Lab Objective

Validate capl programming on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for capl programming.
