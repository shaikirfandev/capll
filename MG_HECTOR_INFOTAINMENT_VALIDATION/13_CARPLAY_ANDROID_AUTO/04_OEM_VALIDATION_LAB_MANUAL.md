# OEM Validation Lab Manual: CarPlay Android Auto

## Lab Objective

Validate carplay android auto on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for carplay android auto.
