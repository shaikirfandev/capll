# Root Cause Analysis Template: CarPlay Android Auto

## Problem Statement

During carplay android auto validation, the IVI behavior deviated from requirement under a defined bench state.
