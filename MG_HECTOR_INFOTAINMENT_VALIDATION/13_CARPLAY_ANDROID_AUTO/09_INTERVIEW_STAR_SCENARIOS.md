# Interview STAR Scenarios: CarPlay Android Auto

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: CarPlay Android Auto failed during bench execution.
...
Task: Automate repeatable checks for carplay android auto.
