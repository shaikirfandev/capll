...
- `test_system_design_smoke`
- `test_system_design_negative_missing_signal`
- `test_system_design_sleep_wakeup_recovery`
- `test_system_design_stress_cycles`
