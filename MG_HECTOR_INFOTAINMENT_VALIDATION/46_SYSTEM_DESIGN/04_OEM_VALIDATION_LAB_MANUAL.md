# OEM Validation Lab Manual: System Design

## Lab Objective

Validate system design on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for system design.
