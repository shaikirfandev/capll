# Interview STAR Scenarios: Cybersecurity Basics

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Cybersecurity Basics failed during bench execution.
...
Task: Automate repeatable checks for cybersecurity basics.
