# Automation Plan: Cybersecurity Basics
...
- `test_cybersecurity_basics_smoke`
- `test_cybersecurity_basics_negative_missing_signal`
- `test_cybersecurity_basics_sleep_wakeup_recovery`
- `test_cybersecurity_basics_stress_cycles`
