# OEM Validation Lab Manual: Cybersecurity Basics

## Lab Objective

Validate cybersecurity basics on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for cybersecurity basics.
