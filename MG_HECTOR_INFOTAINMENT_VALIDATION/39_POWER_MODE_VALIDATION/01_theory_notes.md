# Theory Notes: Power Mode Validation

## Engineering View

In production infotainment validation, power mode validation is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: KL15, KL30, ACC, crank, shutdown and low power mode.
