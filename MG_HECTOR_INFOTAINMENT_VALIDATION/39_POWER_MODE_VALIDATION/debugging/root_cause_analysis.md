# Root Cause Analysis Template: Power Mode Validation

## Problem Statement

During power mode validation validation, the IVI behavior deviated from requirement under a defined bench state.
