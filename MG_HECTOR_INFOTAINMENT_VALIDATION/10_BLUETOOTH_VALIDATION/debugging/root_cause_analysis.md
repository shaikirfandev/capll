# Root Cause Analysis Template: Bluetooth Validation

## Problem Statement

During bluetooth validation validation, the IVI behavior deviated from requirement under a defined bench state.
