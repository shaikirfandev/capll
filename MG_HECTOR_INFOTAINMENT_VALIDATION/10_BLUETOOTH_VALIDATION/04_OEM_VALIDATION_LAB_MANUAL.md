# OEM Validation Lab Manual: Bluetooth Validation

## Lab Objective

Validate bluetooth validation on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for bluetooth validation.
