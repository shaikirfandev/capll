# Theory Notes: Automation Framework

## Engineering View

In production infotainment validation, automation framework is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: pytest, CANoe COM, adb, reports and CI pipelines.
