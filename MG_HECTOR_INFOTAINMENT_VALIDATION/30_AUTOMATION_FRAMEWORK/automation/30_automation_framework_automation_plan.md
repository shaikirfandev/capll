# Automation Plan: Automation Framework
...
- `test_automation_framework_smoke`
- `test_automation_framework_negative_missing_signal`
- `test_automation_framework_sleep_wakeup_recovery`
- `test_automation_framework_stress_cycles`
