# Root Cause Analysis Template: Automation Framework

## Problem Statement

During automation framework validation, the IVI behavior deviated from requirement under a defined bench state.
