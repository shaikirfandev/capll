# Interview STAR Scenarios: Automation Framework

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Automation Framework failed during bench execution.
...
Task: Automate repeatable checks for automation framework.
