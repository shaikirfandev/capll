# Theory Notes: Functional Safety

## Engineering View

In production infotainment validation, functional safety is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: safety goals, camera availability, warnings and validation evidence.
