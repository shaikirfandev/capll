# OEM Validation Lab Manual: Functional Safety

## Lab Objective

Validate functional safety on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for functional safety.
