# Root Cause Analysis Template: Functional Safety

## Problem Statement

During functional safety validation, the IVI behavior deviated from requirement under a defined bench state.
