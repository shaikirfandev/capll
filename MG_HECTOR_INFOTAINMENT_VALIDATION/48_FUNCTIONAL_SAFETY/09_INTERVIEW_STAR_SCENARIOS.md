# Interview STAR Scenarios: Functional Safety

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Functional Safety failed during bench execution.
...
Task: Automate repeatable checks for functional safety.
