# Root Cause Analysis Template: Interview Preparation

## Problem Statement

During interview preparation validation, the IVI behavior deviated from requirement under a defined bench state.
