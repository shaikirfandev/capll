# Theory Notes: Vector CANoe

## Engineering View

In production infotainment validation, vector canoe is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: configuration, measurement, rest bus simulation and test modules.
