# OEM Validation Lab Manual: Vector CANoe

## Lab Objective

Validate vector canoe on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for vector canoe.
