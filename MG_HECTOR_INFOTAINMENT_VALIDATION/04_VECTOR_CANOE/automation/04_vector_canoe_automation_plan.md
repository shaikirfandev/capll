...
- `test_vector_canoe_smoke`
- `test_vector_canoe_negative_missing_signal`
- `test_vector_canoe_sleep_wakeup_recovery`
- `test_vector_canoe_stress_cycles`
