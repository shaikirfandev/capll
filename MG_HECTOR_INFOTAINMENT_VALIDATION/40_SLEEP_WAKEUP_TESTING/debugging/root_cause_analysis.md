# Root Cause Analysis Template: Sleep Wakeup Testing

## Problem Statement

During sleep wakeup testing validation, the IVI behavior deviated from requirement under a defined bench state.
