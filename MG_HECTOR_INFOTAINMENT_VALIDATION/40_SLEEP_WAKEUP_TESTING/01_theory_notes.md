# Theory Notes: Sleep Wakeup Testing

## Engineering View

In production infotainment validation, sleep wakeup testing is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: sleep current, wake triggers, CAN wakeup and retention.
