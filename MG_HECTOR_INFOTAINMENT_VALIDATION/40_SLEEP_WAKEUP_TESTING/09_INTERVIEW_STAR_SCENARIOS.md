# Interview STAR Scenarios: Sleep Wakeup Testing

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Sleep Wakeup Testing failed during bench execution.
...
Task: Automate repeatable checks for sleep wakeup testing.
