# Automation Plan: Sleep Wakeup Testing
...
- `test_sleep_wakeup_testing_smoke`
- `test_sleep_wakeup_testing_negative_missing_signal`
- `test_sleep_wakeup_testing_sleep_wakeup_recovery`
- `test_sleep_wakeup_testing_stress_cycles`
