# OEM Validation Lab Manual: Android Logcat

## Lab Objective

Validate android logcat on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for android logcat.
