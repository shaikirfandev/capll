...
- `test_real_projects_smoke`
- `test_real_projects_negative_missing_signal`
- `test_real_projects_sleep_wakeup_recovery`
- `test_real_projects_stress_cycles`
