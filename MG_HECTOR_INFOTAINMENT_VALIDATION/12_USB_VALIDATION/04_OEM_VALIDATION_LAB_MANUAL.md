# OEM Validation Lab Manual: USB Validation

## Lab Objective

Validate usb validation on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for usb validation.
