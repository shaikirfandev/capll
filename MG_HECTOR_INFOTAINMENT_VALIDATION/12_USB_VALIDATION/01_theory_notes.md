# Theory Notes: USB Validation

## Engineering View

In production infotainment validation, usb validation is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: enumeration, media indexing, projection, power and fault cases.
