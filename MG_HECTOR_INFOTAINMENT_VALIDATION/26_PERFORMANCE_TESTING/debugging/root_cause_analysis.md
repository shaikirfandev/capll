# Root Cause Analysis Template: Performance Testing

## Problem Statement

During performance testing validation, the IVI behavior deviated from requirement under a defined bench state.
