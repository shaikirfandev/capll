# Interview STAR Scenarios: Performance Testing

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Performance Testing failed during bench execution.
...
Task: Automate repeatable checks for performance testing.
