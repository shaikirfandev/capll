# Automation Plan: Performance Testing
...
- `test_performance_testing_smoke`
- `test_performance_testing_negative_missing_signal`
- `test_performance_testing_sleep_wakeup_recovery`
- `test_performance_testing_stress_cycles`
