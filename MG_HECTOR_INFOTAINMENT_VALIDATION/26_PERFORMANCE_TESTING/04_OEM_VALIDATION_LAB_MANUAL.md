# OEM Validation Lab Manual: Performance Testing

## Lab Objective

Validate performance testing on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for performance testing.
