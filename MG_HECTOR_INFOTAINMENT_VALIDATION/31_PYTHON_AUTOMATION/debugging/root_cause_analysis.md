# Root Cause Analysis Template: Python Automation

## Problem Statement

During python automation validation, the IVI behavior deviated from requirement under a defined bench state.
