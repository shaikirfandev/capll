# Interview STAR Scenarios: Python Automation

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Python Automation failed during bench execution.
...
Task: Automate repeatable checks for python automation.
