# OEM Validation Lab Manual: Python Automation

## Lab Objective

Validate python automation on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for python automation.
