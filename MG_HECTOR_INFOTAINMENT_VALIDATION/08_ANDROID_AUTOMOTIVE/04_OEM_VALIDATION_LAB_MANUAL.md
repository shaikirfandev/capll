# OEM Validation Lab Manual: Android Automotive

## Lab Objective

Validate android automotive on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for android automotive.
