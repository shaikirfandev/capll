# Interview STAR Scenarios: Android Automotive

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Android Automotive failed during bench execution.
...
Task: Automate repeatable checks for android automotive.
