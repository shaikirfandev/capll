# Theory Notes: Android Automotive

## Engineering View

In production infotainment validation, android automotive is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: AAOS stack, services, adb, HAL, apps and vehicle properties.
