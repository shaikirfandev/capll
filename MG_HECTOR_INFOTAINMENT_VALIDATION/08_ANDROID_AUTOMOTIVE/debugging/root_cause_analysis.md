# Root Cause Analysis Template: Android Automotive

## Problem Statement

During android automotive validation, the IVI behavior deviated from requirement under a defined bench state.
