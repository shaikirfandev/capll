# OEM Validation Lab Manual: Automotive Basics

## Lab Objective

Validate automotive basics on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for automotive basics.
