# Automation Plan: Automotive Basics
...
- `test_automotive_basics_smoke`
- `test_automotive_basics_negative_missing_signal`
- `test_automotive_basics_sleep_wakeup_recovery`
- `test_automotive_basics_stress_cycles`
