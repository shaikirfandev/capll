# Interview STAR Scenarios: Automotive Basics

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Automotive Basics failed during bench execution.
...
Task: Automate repeatable checks for automotive basics.
