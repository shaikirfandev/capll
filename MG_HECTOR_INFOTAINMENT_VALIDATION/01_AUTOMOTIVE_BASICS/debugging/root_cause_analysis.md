# Root Cause Analysis Template: Automotive Basics

## Problem Statement

During automotive basics validation, the IVI behavior deviated from requirement under a defined bench state.
