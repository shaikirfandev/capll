# Automation Plan: Reverse Camera
...
- `test_reverse_camera_smoke`
- `test_reverse_camera_negative_missing_signal`
- `test_reverse_camera_sleep_wakeup_recovery`
- `test_reverse_camera_stress_cycles`
