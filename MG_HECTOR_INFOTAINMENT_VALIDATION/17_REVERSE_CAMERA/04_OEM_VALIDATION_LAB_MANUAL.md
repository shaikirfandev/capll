# OEM Validation Lab Manual: Reverse Camera

## Lab Objective

Validate reverse camera on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for reverse camera.
