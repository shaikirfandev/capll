# Root Cause Analysis Template: CAN Signal Simulation

## Problem Statement

During can signal simulation validation, the IVI behavior deviated from requirement under a defined bench state.
