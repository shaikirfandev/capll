# Automation Plan: CAN Signal Simulation
...
- `test_can_signal_simulation_smoke`
- `test_can_signal_simulation_negative_missing_signal`
- `test_can_signal_simulation_sleep_wakeup_recovery`
- `test_can_signal_simulation_stress_cycles`
