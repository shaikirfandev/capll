# OEM Validation Lab Manual: CAN Signal Simulation

## Lab Objective

Validate can signal simulation on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for can signal simulation.
