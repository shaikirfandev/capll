# Interview STAR Scenarios: CAN Signal Simulation

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: CAN Signal Simulation failed during bench execution.
...
Task: Automate repeatable checks for can signal simulation.
