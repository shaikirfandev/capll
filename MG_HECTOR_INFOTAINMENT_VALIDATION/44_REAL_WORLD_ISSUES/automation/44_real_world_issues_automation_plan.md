# Automation Plan: Real World Issues
...
- `test_real_world_issues_smoke`
- `test_real_world_issues_negative_missing_signal`
- `test_real_world_issues_sleep_wakeup_recovery`
- `test_real_world_issues_stress_cycles`
