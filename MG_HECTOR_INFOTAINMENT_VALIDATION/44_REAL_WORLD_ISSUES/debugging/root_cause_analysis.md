# Root Cause Analysis Template: Real World Issues

## Problem Statement

During real world issues validation, the IVI behavior deviated from requirement under a defined bench state.
