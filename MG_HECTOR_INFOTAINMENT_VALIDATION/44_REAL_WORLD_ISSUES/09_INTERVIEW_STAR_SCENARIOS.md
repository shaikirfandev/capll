# Interview STAR Scenarios: Real World Issues

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Real World Issues failed during bench execution.
...
Task: Automate repeatable checks for real world issues.
