# OEM Validation Lab Manual: Real World Issues

## Lab Objective

Validate real world issues on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for real world issues.
