# OEM Validation Lab Manual: Navigation System

## Lab Objective

Validate navigation system on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for navigation system.
