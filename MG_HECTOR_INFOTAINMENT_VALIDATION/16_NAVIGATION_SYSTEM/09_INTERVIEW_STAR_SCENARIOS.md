# Interview STAR Scenarios: Navigation System

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Navigation System failed during bench execution.
...
Task: Automate repeatable checks for navigation system.
