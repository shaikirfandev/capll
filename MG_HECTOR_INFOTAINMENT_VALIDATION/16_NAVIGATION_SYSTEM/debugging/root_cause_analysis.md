# Root Cause Analysis Template: Navigation System

## Problem Statement

During navigation system validation, the IVI behavior deviated from requirement under a defined bench state.
