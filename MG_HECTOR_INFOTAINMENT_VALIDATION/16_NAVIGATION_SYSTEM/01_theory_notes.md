# Theory Notes: Navigation System

## Engineering View

In production infotainment validation, navigation system is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: GNSS, map, route, guidance, dead reckoning and voice prompts.
