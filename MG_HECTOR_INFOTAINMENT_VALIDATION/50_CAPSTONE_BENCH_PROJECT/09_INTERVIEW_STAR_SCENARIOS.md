# Interview STAR Scenarios: Capstone Bench Project

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Capstone Bench Project failed during bench execution.
...
Task: Automate repeatable checks for capstone bench project.
