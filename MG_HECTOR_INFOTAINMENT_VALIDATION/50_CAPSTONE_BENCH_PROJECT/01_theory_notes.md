# Theory Notes: Capstone Bench Project

## Engineering View

In production infotainment validation, capstone bench project is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: complete MG Hector-style IVI validation release simulation.
