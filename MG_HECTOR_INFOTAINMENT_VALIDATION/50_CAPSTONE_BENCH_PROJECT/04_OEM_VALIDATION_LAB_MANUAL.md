# OEM Validation Lab Manual: Capstone Bench Project

## Lab Objective

Validate capstone bench project on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for capstone bench project.
