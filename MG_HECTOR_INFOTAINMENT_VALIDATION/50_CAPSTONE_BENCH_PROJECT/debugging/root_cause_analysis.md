# Root Cause Analysis Template: Capstone Bench Project

## Problem Statement

During capstone bench project validation, the IVI behavior deviated from requirement under a defined bench state.
