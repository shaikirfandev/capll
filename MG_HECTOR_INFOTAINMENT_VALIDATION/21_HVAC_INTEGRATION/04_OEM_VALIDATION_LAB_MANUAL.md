# OEM Validation Lab Manual: HVAC Integration

## Lab Objective

Validate hvac integration on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for hvac integration.
