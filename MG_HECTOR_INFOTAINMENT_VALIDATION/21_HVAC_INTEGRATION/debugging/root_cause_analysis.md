# Root Cause Analysis Template: HVAC Integration

## Problem Statement

During hvac integration validation, the IVI behavior deviated from requirement under a defined bench state.
