...
- `test_ota_testing_smoke`
- `test_ota_testing_negative_missing_signal`
- `test_ota_testing_sleep_wakeup_recovery`
- `test_ota_testing_stress_cycles`
