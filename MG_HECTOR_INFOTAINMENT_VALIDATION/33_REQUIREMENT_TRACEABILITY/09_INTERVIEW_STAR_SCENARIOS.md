# Interview STAR Scenarios: Requirement Traceability

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Requirement Traceability failed during bench execution.
...
Task: Automate repeatable checks for requirement traceability.
