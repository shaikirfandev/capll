# Root Cause Analysis Template: Requirement Traceability

## Problem Statement

During requirement traceability validation, the IVI behavior deviated from requirement under a defined bench state.
