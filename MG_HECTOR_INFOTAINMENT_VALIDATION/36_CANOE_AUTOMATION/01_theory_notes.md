# Theory Notes: CANoe Automation

## Engineering View

In production infotainment validation, canoe automation is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: test modules, XML reports, signal verification and regression.
