# Root Cause Analysis Template: CANoe Automation

## Problem Statement

During canoe automation validation, the IVI behavior deviated from requirement under a defined bench state.
