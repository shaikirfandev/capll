# OEM Validation Lab Manual: CANoe Automation

## Lab Objective

Validate canoe automation on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for canoe automation.
