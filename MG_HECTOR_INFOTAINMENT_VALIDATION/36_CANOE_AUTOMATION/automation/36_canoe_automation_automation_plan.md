# Automation Plan: CANoe Automation
...
- `test_canoe_automation_smoke`
- `test_canoe_automation_negative_missing_signal`
- `test_canoe_automation_sleep_wakeup_recovery`
- `test_canoe_automation_stress_cycles`
