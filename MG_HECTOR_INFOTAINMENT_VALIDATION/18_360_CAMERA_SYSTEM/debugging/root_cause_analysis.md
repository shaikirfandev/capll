# Root Cause Analysis Template: 360 Camera System

## Problem Statement

During 360 camera system validation, the IVI behavior deviated from requirement under a defined bench state.
