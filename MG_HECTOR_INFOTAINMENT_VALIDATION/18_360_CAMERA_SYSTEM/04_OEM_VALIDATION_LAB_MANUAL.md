# OEM Validation Lab Manual: 360 Camera System

## Lab Objective

Validate 360 camera system on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for 360 camera system.
