# OEM Validation Lab Manual: Vehicle Signal Simulation

## Lab Objective

Validate vehicle signal simulation on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for vehicle signal simulation.
