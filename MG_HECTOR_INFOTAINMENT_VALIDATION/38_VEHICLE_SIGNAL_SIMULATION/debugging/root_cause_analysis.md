# Root Cause Analysis Template: Vehicle Signal Simulation

## Problem Statement

During vehicle signal simulation validation, the IVI behavior deviated from requirement under a defined bench state.
