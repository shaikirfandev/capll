# Interview STAR Scenarios: Vehicle Signal Simulation

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Vehicle Signal Simulation failed during bench execution.
...
Task: Automate repeatable checks for vehicle signal simulation.
