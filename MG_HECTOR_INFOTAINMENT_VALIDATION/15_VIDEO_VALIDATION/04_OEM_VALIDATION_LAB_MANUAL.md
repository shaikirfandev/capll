# OEM Validation Lab Manual: Video Validation

## Lab Objective

Validate video validation on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for video validation.
