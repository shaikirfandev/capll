# Automation Plan: Video Validation
...
- `test_video_validation_smoke`
- `test_video_validation_negative_missing_signal`
- `test_video_validation_sleep_wakeup_recovery`
- `test_video_validation_stress_cycles`
