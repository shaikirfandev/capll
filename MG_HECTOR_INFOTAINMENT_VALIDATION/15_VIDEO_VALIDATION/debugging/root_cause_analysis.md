# Root Cause Analysis Template: Video Validation

## Problem Statement

During video validation validation, the IVI behavior deviated from requirement under a defined bench state.
