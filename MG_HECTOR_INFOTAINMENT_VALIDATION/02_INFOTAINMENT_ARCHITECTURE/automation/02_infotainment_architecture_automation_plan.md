# Automation Plan: Infotainment Architecture
...
- `test_infotainment_architecture_smoke`
- `test_infotainment_architecture_negative_missing_signal`
- `test_infotainment_architecture_sleep_wakeup_recovery`
- `test_infotainment_architecture_stress_cycles`
