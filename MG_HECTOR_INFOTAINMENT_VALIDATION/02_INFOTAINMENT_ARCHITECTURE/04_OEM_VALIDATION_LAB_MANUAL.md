# OEM Validation Lab Manual: Infotainment Architecture

## Lab Objective

Validate infotainment architecture on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for infotainment architecture.
