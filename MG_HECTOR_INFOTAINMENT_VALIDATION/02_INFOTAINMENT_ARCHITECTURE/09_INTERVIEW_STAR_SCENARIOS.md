# Interview STAR Scenarios: Infotainment Architecture

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Infotainment Architecture failed during bench execution.
...
Task: Automate repeatable checks for infotainment architecture.
