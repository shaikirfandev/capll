# Root Cause Analysis Template: Infotainment Architecture

## Problem Statement

During infotainment architecture validation, the IVI behavior deviated from requirement under a defined bench state.
