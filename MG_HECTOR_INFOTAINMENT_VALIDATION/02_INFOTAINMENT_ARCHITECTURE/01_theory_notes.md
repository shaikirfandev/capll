# Theory Notes: Infotainment Architecture

## Engineering View

In production infotainment validation, infotainment architecture is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: IVI hardware, software, connectivity, audio and display domains.
