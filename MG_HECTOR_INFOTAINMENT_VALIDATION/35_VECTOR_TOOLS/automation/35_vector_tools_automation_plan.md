...
- `test_vector_tools_smoke`
- `test_vector_tools_negative_missing_signal`
- `test_vector_tools_sleep_wakeup_recovery`
- `test_vector_tools_stress_cycles`
