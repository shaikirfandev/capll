# Theory Notes: Vector Tools

## Engineering View

In production infotainment validation, vector tools is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: CANalyzer, CANoe, CANape, vTESTstudio and DBC handling.
