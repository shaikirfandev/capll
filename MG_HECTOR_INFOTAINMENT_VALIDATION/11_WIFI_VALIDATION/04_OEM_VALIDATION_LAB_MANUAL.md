# OEM Validation Lab Manual: WiFi Validation

## Lab Objective

Validate wifi validation on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for wifi validation.
