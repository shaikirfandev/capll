# Automation Plan: WiFi Validation
...
- `test_wifi_validation_smoke`
- `test_wifi_validation_negative_missing_signal`
- `test_wifi_validation_sleep_wakeup_recovery`
- `test_wifi_validation_stress_cycles`
