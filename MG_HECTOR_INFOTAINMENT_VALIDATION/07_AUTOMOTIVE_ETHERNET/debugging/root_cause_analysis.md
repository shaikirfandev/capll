# Root Cause Analysis Template: Automotive Ethernet

## Problem Statement

During automotive ethernet validation, the IVI behavior deviated from requirement under a defined bench state.
