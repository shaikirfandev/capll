# Interview STAR Scenarios: Automotive Ethernet

## Scenario 1: Bench Issue Isolated From Software Issue

Situation: Automotive Ethernet failed during bench execution.
...
Task: Automate repeatable checks for automotive ethernet.
