# OEM Validation Lab Manual: Automotive Ethernet

## Lab Objective

Validate automotive ethernet on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for automotive ethernet.
