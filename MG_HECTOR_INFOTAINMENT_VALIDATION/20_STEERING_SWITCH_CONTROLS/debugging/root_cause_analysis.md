# Root Cause Analysis Template: Steering Switch Controls

## Problem Statement

During steering switch controls validation, the IVI behavior deviated from requirement under a defined bench state.
