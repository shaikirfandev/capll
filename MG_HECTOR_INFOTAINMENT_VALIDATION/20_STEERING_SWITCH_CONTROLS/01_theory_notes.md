# Theory Notes: Steering Switch Controls

## Engineering View

In production infotainment validation, steering switch controls is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: short press, long press, media, volume and voice buttons.
