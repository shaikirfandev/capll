# OEM Validation Lab Manual: Steering Switch Controls

## Lab Objective

Validate steering switch controls on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for steering switch controls.
