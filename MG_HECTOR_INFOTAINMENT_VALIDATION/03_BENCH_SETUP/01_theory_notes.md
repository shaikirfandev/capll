# Theory Notes: Bench Setup

## Engineering View

In production infotainment validation, bench setup is never tested as an isolated feature only. It is validated as a chain of vehicle signals, middleware state, Android/Linux services, app behavior, persistence, user interaction and recovery behavior after power or connectivity disturbance.

Core focus: power, harnessing, ignition, CAN, Ethernet and lab workflow.
