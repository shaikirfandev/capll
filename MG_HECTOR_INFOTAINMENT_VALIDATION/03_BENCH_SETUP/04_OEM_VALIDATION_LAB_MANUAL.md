# OEM Validation Lab Manual: Bench Setup

## Lab Objective

Validate bench setup on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for bench setup.
