# Automation Plan: Stress Testing
...
- `test_stress_testing_smoke`
- `test_stress_testing_negative_missing_signal`
- `test_stress_testing_sleep_wakeup_recovery`
- `test_stress_testing_stress_cycles`
