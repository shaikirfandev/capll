# OEM Validation Lab Manual: Stress Testing

## Lab Objective

Validate stress testing on an MG Hector-style IVI bench using CANoe, CAPL, Python, adb/logcat and UDS diagnostics.
...
4. Execute the nominal test path for stress testing.
